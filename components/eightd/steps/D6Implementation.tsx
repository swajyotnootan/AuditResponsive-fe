...
export default function D6Implementation({ eventId, updateParent }: D6ImplementationProps) {
      ...
      try {
        ...
        if (response?.success && response.data?.content?.d6?.[0]) {
          ...
          setFormData({
            ...
            communicatedToStakeholders: d6Data.communicatedToStakeholders || 'Yes',
            notes: d6Data.notes || '',
          });
          setRecordId(eventId);
        }
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <Text style={styles.headerTitle}>D6 – Implementation & Communication</Text>
          {eventId && (
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.fieldGroup}>
          <Text style={styles.label}>Implementation Date & Time <Text style={styles.required}>*</Text></Text>
          <TextInput
            style={styles.input}
          ...
          <View style={styles.radioGroup}>
            {['Yes', 'No'].map((option) => (
              <TouchableOpacity
                ...
                style={[
                  styles.radioOption,
                  formData.communicatedToStakeholders === option && styles.radioOptionActive
                ]}
                onPress={() => handleChange('communicatedToStakeholders', option)}
              >
                <View style={[
                  styles.radioCircle,
                  formData.communicatedToStakeholders === option && styles.radioCircleActive
                ]}>
                  {formData.communicatedToStakeholders === option && <View style={styles.radioInner} />}
                </View>
