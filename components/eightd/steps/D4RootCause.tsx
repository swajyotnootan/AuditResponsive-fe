...
export default function D4RootCause({ eventId, updateParent }: D4RootCauseProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.fieldGroup}>
          <Text style={styles.label}>Root Cause Summary <Text style={styles.required}>*</Text></Text>
          <TextInput
        ...
        <View style={styles.fieldGroup}>
          <Text style={styles.label}>Does the Root Cause reveal flaws in business processes?</Text>
          <View style={styles.radioGroup}>
            {['Yes', 'No'].map((option) => (
              <TouchableOpacity
                ...
                style={[
                  styles.radioOption,
                  formData.businessProcessFlaws === option && styles.radioOptionActive
                ]}
                onPress={() => handleChange('businessProcessFlaws', option)}
              >
                <View style={[
                  styles.radioCircle,
                  formData.businessProcessFlaws === option && styles.radioCircleActive
                ]}>
                  {formData.businessProcessFlaws === option && <View style={styles.radioInner} />}
                </View>
        ...
        <View style={styles.fieldGroup}>
          <Text style={styles.label}>Reason problem was not detected/resolved</Text>
          <TextInput
            style={[styles.input, styles.textArea]}
