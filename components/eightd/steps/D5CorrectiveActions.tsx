...
export default function D5CorrectiveActions({ eventId, updateParent }: D5CorrectiveActionsProps) {
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <Text style={styles.headerTitle}>D5 – Permanent Corrective Actions</Text>
          {eventId && (
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.fieldGroup}>
          <Text style={styles.label}>Corrective Actions <Text style={styles.required}>*</Text></Text>
          ...
          {predefinedActions.map((action, idx) => (
            <TouchableOpacity
              ...
              style={[
                ...
                formData.actions.some(a => a.action === action) && styles.checkboxOptionActive
              ]}
              onPress={() => toggleAction(action)}
            >
              <View style={[
                styles.checkbox,
                formData.actions.some(a => a.action === action) && styles.checkboxActive
              ]}>
          ...
          <Text style={[styles.sectionLabel, { marginTop: 16 }]}>Custom Actions:</Text>
          <View style={styles.addCustomContainer}>
            ...
            />
            <TouchableOpacity style={styles.addCustomButton} onPress={addCustomAction}>
